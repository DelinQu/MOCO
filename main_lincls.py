...
from src.train.trainer_lincls import train, save_checkpoint, adjust_learning_rate, sanity_check
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    valdir = os.path.join('/mnt/petrelfs/qudelin/DATA_CACHE/ImageNet/val')
